...
// //                             <input type="text" placeholder="Search..." value={inputProduct}
// //                                 onChange={(e) => setInputProduct(e.target.value)} />
// //                         </div>
// //                         <button disabled={loading} className="search-button">SEARCH</button>
// //                     </div>
// //                 </form>
...
// //                                     <span>{store.charAt(0).toUpperCase() + store.slice(1)} - "{productName}"</span>
// //                                 </div>
