...
const Header_Table = ({
  ...
  const handleOverlaySubmit = async (data) => {
    ...
    const url = editError
      ? `/api/WindowsError/${editError._id}`
      : "/api/WindowsError";
        ...
        <div className={styles.controls}>
          ...
          >
            ...
            <img
              ...
              src="https://res.cloudinary.com/dr9yx1tod/image/upload/v1748906274/mqqz3wkwquqmqn6bfopi.png"
              alt="add"
            />
          </div>
          <input
            ...
            id="importCsv"
          />
          <label htmlFor="importCsv" className={styles.downloadBtn}>
            Import CSV
          </label>
          <input
            type="text"
              ...
              <tr>
                <th className={styles.checkboxCell}>
                  <input
                    ...
                    checked={selectedItems.length === errors.length}
                  />
                  <span>All</span>
                </th>
                <th>ID</th>
              ...
              {errors.map((error) => (
                <tr key={error._id}>
                  <td className={styles.checkboxCell}>
                    <input
                      type="checkbox"
                      checked={selectedItems.includes(error._id)}
                      onChange={() => handleSelectItem(error._id)}
                    />
                  </td>
                  <td>{error._id}</td>
