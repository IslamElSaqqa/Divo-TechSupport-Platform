...
const Header_Table = ({
  ...
  itemsPerPage = 5,
  data = [
    { id: '1', name: 'El-Sahir', location: 'Sedi Bishr', rating: '4.5', mapLink: 'www.googlemaps.com' },
    { id: '2', name: 'Tarazaan', location: 'Asafra', rating: '3.2', mapLink: 'www.googlemaps.com' },
    { id: '3', name: 'MG', location: 'Montazah 1st', rating: '3.6', mapLink: 'www.googlemaps.com' },
  ]
}) => {
  const [requests, setRequests] = useState([]);
  const [currentPage, setCurrentPage] = useState(1);
